...
public class CreateMentorActivity extends AppCompatActivity {
    ...
    private EditText inputEmail, inputfullName, inputStack;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputStack = (EditText) findViewById(R.id.stack);
        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String stack = inputStack.getText().toString().trim();
                        ...
                        .addOnCompleteListener(CreateMentorActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    User user = new User(email, fullName, mCheckBox.isChecked(),stack, key);
